...
namespace Squidex.Domain.Apps.Entities.Contents.MongoDb
{
    public class MongoDbQueryTests
    {
        ...
        {
            var i = F(ClrFilter.Eq("lastModified", InstantPattern.ExtendedIso.Parse("1988-01-19T12:00:00Z").Value));
        ...
        {
            var i = F(ClrFilter.Eq("data/birthday/iv", InstantPattern.ExtendedIso.Parse("1988-01-19T12:00:00Z").Value));
